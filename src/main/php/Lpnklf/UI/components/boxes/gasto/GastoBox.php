...
namespace Lpnklf\UI\components\boxes\gasto;
...
class GastoBox extends RastyComponent{
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		$xtpl->assign( "monto", LpnklfUIUtils::formatMontoToView( $this->getGasto()->getMonto() ) );
		$xtpl->assign( "observaciones", $this->getGasto()->getObservaciones() );
		$xtpl->assign( "fecha", LpnklfUIUtils::formatDateTimeToView($this->getGasto()->getFecha()) );
		$xtpl->assign( "fechaVencimiento", LpnklfUIUtils::formatDateTimeToView($this->getGasto()->getFechaVencimiento()) );
