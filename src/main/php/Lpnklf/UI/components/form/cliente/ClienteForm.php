...
namespace Lpnklf\UI\components\form\cliente;
...
use Lpnklf\Core\model\Sexo;

use Lpnklf\Core\model\TipoDocumento;
...
class ClienteForm extends Form{
	...
	public function getSexos(){
		...
		return LpnklfUIUtils::localizeEntities(Sexo::getItems());
	}
	
	public function getTiposDocumento(){
		
		return LpnklfUIUtils::localizeEntities(TipoDocumento::getItems());
	}
