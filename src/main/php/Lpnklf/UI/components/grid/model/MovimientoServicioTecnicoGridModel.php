 ...
 * @since 07/04/2018
 */
class MovimientoServicioTecnicoGridModel extends EntityGridModel{
    ...
    public function getService(){
    	...
    	return UIServiceFactory::getUIMovimientoServicioTecnicoService();
    }
...
//	    $this->filter = ComponentFactory::buildByType($componentConfig, $this);
    	...
    	$filter = new UIMovimientoServicioTecnicoCriteria();
		return $filter;    	
    }
