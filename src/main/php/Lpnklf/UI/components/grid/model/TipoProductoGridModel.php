...
use Lpnklf\UI\components\grid\formats\GridBooleanFormat;
...
class TipoProductoGridModel extends EntityGridModel{
	...
	protected function initModel() {
		...
		$column = GridModelBuilder::buildColumn( "servicioTecnico", "tipoProducto.servicioTecnico", 10, EntityGrid::TEXT_ALIGN_CENTER, new GridBooleanFormat() );
		$this->addColumn( $column );
