...
namespace Lpnklf\UI\components\header;
...
class HeaderNav extends RastyComponent{
	...
	public function getMainMenuGroups(){
		...
		$menuGroups=array();
		if( LpnklfUIUtils::isAdminLogged()) {
...
//		$menuGroupProductos->addMenuOption( $this->getMenuProveedores() );*/
	...
	public function getMenuAdmin(){
		...
		$menuOption = new MenuOption();
		$menuOption->setLabel( $this->localize( "menu.estados") );
	...
	public function getMenuCuentas(){
		...
		$menuOption->setIconClass("icon-movimientos");
		$menuOption->setPageName( "MovimientosCaja");
		$menuGroup->addMenuOption( $menuOption );
	...
	public function getMenuAgencia(){
		...
		//$menuGroup->addMenuOption( $this->getMenuTareas() );
		$menuOption = new MenuOption();
		$menuOption->setLabel( $this->localize( "menu.servicios_tecnicos.listar") );
		$menuOption->setPageName( "ServiciosTecnico" );
		$menuOption->setIconClass("icon-tareas");
		$menuGroup->addMenuOption( $menuOption );
		
		$menuOption = new MenuOption();
		$menuOption->setLabel( $this->localize( "menu.servicios_tecnicos.agregar") );
