<?php
namespace Lpnklf\UI\pages\parametros;

use Lpnklf\UI\service\UIServiceFactory;

use Lpnklf\UI\components\filter\model\UIParametroCriteria;

use Lpnklf\UI\components\grid\model\ParametroGridModel;
 ...
 * 
 */
class Parametros extends LpnklfPage{
