<?php
namespace Lpnklf\UI\pages\ventas;

use Lpnklf\UI\service\UIServiceFactory;

use Lpnklf\UI\components\filter\model\UIMovimientoVentaCriteria;

use Lpnklf\UI\components\grid\model\MovimientoVentaGridModel;
 ...
 * 
 */
class MovimientosVenta extends LpnklfPage{
