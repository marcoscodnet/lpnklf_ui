<?php
namespace Lpnklf\UI\pages\gastos\pagar;
...
class GastoPagar extends LpnklfPage{
...
//		
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		$xtpl->assign( "lbl_pendiente", $this->localize( "forma.pago.pendiente") );
			...
			$xtpl->assign( "linkPagarEfectivo", $this->getLinkActionPagarGasto($this->getGasto(), LpnklfUtils::getCuentaUnica(), $this->getBackTo()) );
