<?php
namespace Lpnklf\UI\pages\conceptoMovimientos;

use Lpnklf\UI\service\UIServiceFactory;

use Lpnklf\UI\components\filter\model\UIConceptoMovimientoCriteria;

use Lpnklf\UI\components\grid\model\ConceptoMovimientoGridModel;
 ...
 * 
 */
class ConceptoMovimientos extends LpnklfPage{
