<?php
namespace Lpnklf\UI\pages\clientes\cobrarCtaCte;


use Lpnklf\UI\service\finder\ClienteFinder;

use Lpnklf\UI\service\finder\CuentaFinder;
...
class CobrarCtaCte extends LpnklfPage{
	...
	public function __construct(){
		...
		/*if( LpnklfUIUtils::isCajaSelected() )
			$this->destino = LpnklfUIUtils::getCaja();*/
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		$xtpl->assign("cancel",  $this->getLinkAdminHome() );
