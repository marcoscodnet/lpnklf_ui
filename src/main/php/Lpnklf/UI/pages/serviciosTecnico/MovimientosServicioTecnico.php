...
/**
 * Página para consultar los movimientos de servicioTecnico.
 * 
 * @author Marcos
 * @since 07-04-2018
 * 
 */
class MovimientosServicioTecnico extends LpnklfPage{
	...
	public function getTitle(){
		return $this->localize( "servicioTecnico.movimientos.title" );
	}
...
//		$menuGroup->addMenuOption( $menuOption );
	...
	public function getType(){
		...
		return "MovimientosServicioTecnico";
		
	}	

	public function getModelClazz(){
		return get_class( new MovimientoServicioTecnicoGridModel() );
	}

	public function getUicriteriaClazz(){
		return get_class( new UIMovimientoServicioTecnicoCriteria() );
	}
