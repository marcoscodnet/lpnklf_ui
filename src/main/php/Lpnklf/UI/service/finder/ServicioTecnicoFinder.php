<?php
namespace Lpnklf\UI\service\finder;
...
/**
 * 
 * Finder para serviciosTecnico.
 * 
 * @author Marcos
 * @since 08/03/2018
 */
class ServicioTecnicoFinder implements  IAutocompleteFinder {
	...
	public function findEntitiesByText( $text, $parent=null ){
		...
		$uiCriteria = new UIServicioTecnicoCriteria();
		$uiCriteria->setNombre( $text );
		$uiCriteria->setRowPerPage( 50 );
		return UIServiceFactory::getUIServicioTecnicoService()->getList($uiCriteria);	
	}
	...
	function findEntityByCode( $code, $parent=null ){
		...
		return UIServiceFactory::getUIServicioTecnicoService()->get( $code );
	}
	...
	public function getAttributes(){
		return array("fecha", "cliente", "prioridad");		
	}
	...
	public function getAttributesCallback(){
		return array("oid", "fecha", "cliente", "prioridad");		
	}
