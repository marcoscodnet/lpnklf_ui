...
class Login extends Action{
	...
	public function execute(){
		...
		try {
			...
			//LpnklfUIUtils::setSucursal( LpnklfUtils::getSucursalDefault() );
		
			$user = RastySecurityContext::getUser();
			
			$user = LpnklfUtils::getUserByUsername($user->getUsername());
		
			if( LpnklfUtils::isAdmin($user)){
				
				//$empleado = LpnklfUtils::getEmpleadoDefault();
				LpnklfUIUtils::loginAdmin($user);
