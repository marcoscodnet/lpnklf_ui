...
class LpnklfHomeMetroLayout extends LpnklfMetroLayout{
	...
	public function getContent(){
		...
		$xtpl = $this->getXTemplate( dirname(__DIR__) . "/layouts/LpnklfHomeMetroLayout.htm" );
