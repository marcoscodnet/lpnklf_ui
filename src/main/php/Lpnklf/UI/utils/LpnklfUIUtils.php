...
use Lpnklf\Core\model\DetallePedido;

use Lpnklf\Core\model\EstadoPedido;
...
class LpnklfUIUtils {
	...
	public static function getEstadoServicioCss($estadoServicio){
		$estilos = array(
						1=> "bg-yellow fg-black",
						2=> "bg-orange fg-black",
						3=> "bg-orange fg-black",
						4=> "bg-gray fg-black",
						5=> "bg-lighterBlue fg-black",
						6=> "bg-red fg-white",
						7=> "bg-green fg-black"
						);
						
		return $estilos[$estadoServicio];
	}
